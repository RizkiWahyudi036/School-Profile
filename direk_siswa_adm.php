        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="index_logout.php">Galery</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="index_logout.php">Contact Us</a>
                    </li>
                </ul>
            </div>
            <div>
        ...
        <div class="container mt-5">
            ...
            <div class="row justify-content-evenly fs-5 text-center align-items-center">
              ...
              include_once 'koneksi.php';
                $no=1;
                $data=mysqli_query($connection, "SELECT * FROM db_siswa");
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_siswa.php?nisn=<?php echo $d['nisn'];?>" class="opsi">Edit</a>
                                <a href="hapus_siswa.php?nisn=<?php echo $d['nisn'];?>" class="opsi">Delete</a>
                            </td>
                        </tr>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-6">
                                <div class="edit-data mb-4">
                                    ...
                                    <a href="tambah_siswa.php"><button class="back" style="background-color:rgb(0, 153, 255); color:white">Tambah Data</button></a>
