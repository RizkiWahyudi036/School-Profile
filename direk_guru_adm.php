        ...
        <div class="container mt-5">
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_guru.php ?nip=<?php echo $d['nip'];?>" class="opsi">Edit</a>
                                <a href="hapus_guru.php ?nip=<?php echo $d['nip'];?>" class="opsi">Delete</a>
                            </td>
                        </tr>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-6">
                                <div class="edit-data mb-4">
                                    <a href="tambah_guru.php"><button class="back" style="background-color:rgb(0, 153, 255); color:white">Tambah Data</button></a>
