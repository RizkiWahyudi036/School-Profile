...
<?php
            ...
            include('koneksi.php');
            $nip = $_GET['nip'];
            $show = mysqli_query($connection, "SELECT * FROM db_guru WHERE nip = '$nip'");
                ...
                <div class="col-md-8">
                    <div class="edit-form h-100">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-7">
                                <div class="edit-data">
                                    <form action="aksi_edit_guru.php" method="post">
                                        ...
                                        <input type="text" name="mapel" class="form-control" value="<?php echo $d['mapel']; ?>" required />
