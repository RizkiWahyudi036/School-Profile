...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Okt 2023 pada 03.45
...
('root', '2023-10-10 01:44:58', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
...
-- Database: `pw_2`
--
CREATE DATABASE IF NOT EXISTS `pw_2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pw_2`;
...
<a href="index.php?route=/server/sql&sql_query=SET+SQL_QUOTE_SHOW_CREATE+%3D+1&show_query=1"><span class="text-nowrap"><img src="themes/dot.gif" title="Ubah" alt="Ubah" class="icon ic_b_edit">&nbsp;Ubah</span></a>    </p>
<p>
<code class="sql"><pre>
