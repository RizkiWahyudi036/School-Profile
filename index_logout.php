...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm fixed-top" style="background-color:white ;">
        <div class="container">
            <a class="navbar-brand" href="index_logout.php">SMK Harapan Bangsa</a>
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="direk_siswa_adm.php">Direktori Siswa</a></li>
                            <li><a class="dropdown-item" href="direk_guru_adm.php">Direktori Guru</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
            ...
            <div>
                <a href="aksi_logout.php"><button class="btn btn-info">Logout</button></a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="section-headline text-center mt-5 mb-2">
                                <h1>SELAMAT DATANG </h1><p></p>
                                <h2> Website Resmi SMK Harapan Bangsa</h2>
                            </div>
                            ...
                            <div class="col-md-5">
                            <img src="asset/principal.jpg" width="300" height="420">
                            </div>
                            ...
                            <div class="col-md-12 mt-4 text-start ">
                                ...
                                <p></p>
                                Alhamdulillahi robbil alamin kami panjatkan kehadlirat Allah SWT, bahwasannya dengan rahmat dan karunia-Nya lah akhirnya Website sekolah ini dengan alamat www.smkhb.sch.id dapat kami perbaharui. Kami mengucapkan selamat datang di Website kami Sekolah Menengah Kejuruan Harapan Bangsa yang saya tujukan untuk seluruh unsur pimpinan, guru, karyawan dan siswa serta khalayak umum guna dapat mengakses seluruh informasi tentang segala profil, aktifitas/kegiatan serta fasilitas sekolah kami.
                                
                            </div>
                            </div>
                            <div class="col-md-12 mt-4 text-start ">
                                <p>Kami selaku pimpinan sekolah mengucapkan terima kasih kepada Operator Sekolah pembuat Website ini yang telah berusaha untuk dapat lebih memperkenalkan segala perihal yang dimiliki oleh sekolah. Dan tentunya Website sekolah kami masih terdapat banyak kekurangan, oleh karena itu kepada seluruh civitas akademika dan masyarakat umum dapat memberikan saran dan kritik yang membangun demi kemajuan Website ini lebih lanjut.
                                <p></p>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-blog">
                                <div class="single-blog-img">
                                    <a
                                        href=#>
                                        <img src="asset/n1.jpg" alt="" width="360" height="210">
                                    </a>
                                </div>
                                ...
                                <div class="blog-text">
                                    <p>
                                        Hari Guru dimeriahkan Oleh Jerome Polin dan Waseda Boys
                                    </p>
                                </div>
                                <span>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-blog">
                                <div class="single-blog-img">
                                    <a href="#">
                                        <img src="asset/phon.jpg" alt="" width="360"
                                            height="210">
                                    </a>
                                </div>
                                <div class="space mb-3">
                                ...
                                <div class="blog-text">
                                    <p>
                                        Penanaman 100 pohon menuju Green School
                                    </p>
                                </div>
                                <span>
                                    <a href="#"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="single-blog">
                                <div class="single-blog-img">
                                    <a href="#">
                                        <img src="asset/kom.jpg" alt="" width="360"
                                            height="210">
                                    </a>
                                </div>
                                <div class="space mb-3">
                                ...
                                <div class="blog-text">
                                    <p>
                                        SMK Harapan Bangsa Menjuarai Olimpiade Komputer
                                    </p>
                                </div>
                                <span>
                                    <a href="#"
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 mt-4">
                            <div class="single-blog">
                                <div class="single-blog-img">
                                    <a href="#">
                                        <img src="asset/basket.jpg" alt="" width="360" height="210">
                                    </a>
                                </div>
                                <div class="space mb-3">
                                </div>
                                <div class="blog-text">
                                    <p>
                                        SMK Harapan Bangsa memperoleh Juara 1 Liga Basket 
                                    </p>
                                </div>
                                <span>
                                    <a href="#"
    ...
    <div class="blog-area">
            <div class="blog-inner area-padding">
                ...
                <div class="container ">
                    ...
                    <div class="card" >
                        <div class="image">
                        <img src="asset/kom.jpg" class="card-img-top" alt="">
                        </div>
                    </div>
                    </div>
                    <div class="col-md-3 mb-4">
